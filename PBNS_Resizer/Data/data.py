...
class Data:
    def __init__(self, gender, shape_range=3, tightness_range=1, epoch_steps=16000, batch_size=10, mode='train', shape_size=10):
        """
        Args:
        ...
        if mode == 'train':
            ds = ds.shuffle(epoch_steps)  # not really necessary
    ...
    def _next(self, i):
        # random shape
        shape = self._shape_range * np.random.uniform(0, 1, size=(self._shape_size,))
